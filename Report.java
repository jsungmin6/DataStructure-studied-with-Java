...
public class Report {
	public static void main(String args[]){
		...
		exp = exp.replaceAll("-1", "( 0 - 1 )");
		exp = exp.replaceAll("-2", "( 0 - 2 )");
		exp = exp.replaceAll("-3", "( 0 - 3 )");
		exp = exp.replaceAll("-4", "( 0 - 4 )");
		exp = exp.replaceAll("-5", "( 0 - 5 )");
		exp = exp.replaceAll("-6", "( 0 - 6 )");
		exp = exp.replaceAll("-7", "( 0 - 7 )");
		exp = exp.replaceAll("-8", "( 0 - 8 )");
		exp = exp.replaceAll("-9", "( 0 - 9 )");
